import { clubRuleKey, townRuleKey } from "../type";
...
export class RuleDiff {
    static TownRule(from, to, language, simplify) {
        ...
        const merge = Object.fromEntries(townRuleKey.map((key) => [key, { ...from[key], ...to[key] }]));
    ...
    static ClubRule(from, to, language, simplify) {
        ...
        const merge = Object.fromEntries(clubRuleKey.map((key) => [key, { ...from[key], ...to[key] }]));
