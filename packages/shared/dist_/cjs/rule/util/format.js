...
class RuleFormatter {
    constructor(language) {
        ...
        this.pack = (0, language_1.loadLanguage)(language);
    }
    apply(template, ...args) {
    ...
    FeeCollection(feeCollection) {
        ...
        return {
            taxRate: (0, number_1.parseFraction)(taxRate).n !== 0
    ...
    FeeUsage(feeUsage) {
        ...
        return {
            ...
            distributeRemaining: (0, number_1.parseFraction)(distributeRemaining).n !== 0
